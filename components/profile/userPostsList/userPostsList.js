...
import styles from "./userPostsList.style";

import useSupabase from "../../../services/useSupabase";
import { useAuth } from "../../../context/AuthContext";
import { getUserContents } from "../../../services/getData";
...
const UserPostsList = () => {
  ...
  const { user } = useAuth();
  const { data, isLoading, refetch, error } = useSupabase(() => getUserContents(user.id));
